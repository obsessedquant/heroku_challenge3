...
def getframes():
    ...
    video_capture = cv2.VideoCapture(
        0
    )  # start capturing from default 0 (webcam) change 0 to a file name if you want to check emotions on a video
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            cv2.rectangle(
                frame, (x, y), (x + w, y + h), (0, 0, 255), 1
            )  # change the color and size of the box
            ...
            cv2.putText(
                ...
                (0, 0, 255),
                3,
            )  # Change the color of the emotion text
        #Gender
            ...
            cv2.putText(frame,gender_label,(int(x),int(y+250)),cv2.FONT_HERSHEY_SIMPLEX,1,(0,255,0),2)
